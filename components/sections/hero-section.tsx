...
export default function HeroSection() {
  return (
    <section className="relative  my-2 lg:min-w-[1330] 2xl:min-w-[1700px] mx-auto max-h-[580px]">
      {/* Background Image */}
      <div
      ...
      {/* White Content Box */}
      <div className="relative px-4 lg:max-w-6xl 2xl:max-w-7xl mx-auto py-12">
        <div className="max-w-[500px]">
          <div className="bg-gray-50 rounded-xl p-9 shadow-2xl">
            <h1 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6 max-w-xs">
