...
export default function ProfSection({}: Props) {
  return (
    ...
    <div className="pt-12 pb-10 bg-[#EBF1F7] ">
      <div className=" max-w-7xl mx-auto gap-6 flex flex-col px-10">
        ...
        <div className="flex gap-16 w-full">
          <div className="relative lg:w-5/12 flex justify-center shrink-0 items-stretch">
            ...
            <div className="absolute bottom-[130px] left-[53%] -translate-x-1/2 flex -space-x-4">
              <Image
                className="w-20 h-20 rounded-full border-1 object-cover"
                src="/avatar1.webp"
                width={100}
                height={100}
                alt="Profile 1"
            ...
            <div className="absolute bottom-[70px] left-[49%] -translate-x-1/2 flex -space-x-4">
              <Image
                className="w-20 h-20 rounded-full border-1 object-cover"
                src="/avatar5.webp"
                width={100}
          ...
          <div className="w-full lg:w-7/12 flex flex-col pt-12 lg:pt-0 ">
