...
export default function PartenersSection({}: Props) {
  return (
    <section className="pb-15 px-0 lg:px-20 bg-white">
      <div className="max-w-7xl mx-auto text-center">
        <h2 className="text-[22px] font-bold mb-4 md:mb-12 px-4 lg:px-20">
          PetitsBureaux est partenaire de tous les acteurs du bureau flexible
        </h2>

        {/* Partner Logos Grid */}
        <div className="flex overflow-x-auto overflow-y-hidden scrollbar-hide lg:grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-8 mb-4 lg:mb-8">
          {/* Row 1 */}
          <div className="flex items-center justify-center md:h-16">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-end px-4 lg:px-20">
